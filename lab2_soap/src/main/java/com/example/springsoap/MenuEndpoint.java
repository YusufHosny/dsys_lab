...
public class MenuEndpoint {
    ...
    @PayloadRoot(namespace = NAMESPACE_URI, localPart = "getSmallestMealRequest")
    @ResponsePayload
    public GetSmallestMealResponse getSmallestMeal(@RequestPayload GetSmallestMealRequest request) {
        GetSmallestMealResponse response = new GetSmallestMealResponse();
        response.setMeal(mealrepo.findSmallestMeal());
    ...
    @ResponsePayload
    public AddOrderResponse getCheapestMeal(@RequestPayload AddOrderRequest request) {
